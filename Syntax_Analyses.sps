...
***Sensitivity versus Stigmatization toward Victims: Verb-Specific Models (pg. 19) - see Table 5. Regressions 
predicting ratings of hypothetical victims as contaminated and injured for rape, stab and strangle from moral 
values, demographics, implicit causality object-bias for rape, stab, and strangle, and agent and patient contribution 
for rape, stab, and strangle, in Study 1 (n=459).***
...
REGRESSION
  ...
  /NOORIGIN 
  /DEPENDENT rape_2
  /METHOD=ENTER BINDING INDIVIDUALIZING POLITICS GENDER RELIGION RAPED_IC Raped_agent Raped_patient.    
...
REGRESSION
  ...
  /CRITERIA=PIN(.05) POUT(.10)
  /NOORIGIN 
  /DEPENDENT stabbing_2
  /METHOD=ENTER BINDING INDIVIDUALIZING POLITICS GENDER RELIGION STABBED_IC Stabbed_patient 
    Stabbed_agent.
...
REGRESSION
  ...
  /CRITERIA=PIN(.05) POUT(.10)
  /NOORIGIN 
  /DEPENDENT strangle_2
  /METHOD=ENTER BINDING INDIVIDUALIZING POLITICS GENDER RELIGION STRANGLED_IC Strang_patient 
    Strang_agent.
